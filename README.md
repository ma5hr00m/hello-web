...
如果你想对自己的阶段性学习成果有一个认知，想知道自己什么时候能够更进一步，可以把下面这个链接中的小任务当作参考，限时 1 week：[2023 杭电助手技术部前端任务内容](https://wabuibd23as.feishu.cn/docx/BbghdHJOwobkiLxLMdlcvqdjnSc)。
...
当你熟悉 Golang 语法之后，就可以上手应用框架了。不过，在开始之前，先介绍下 SQL 是什么。



推荐给初学者的 Golang 后端三件套是 `Gin` + `Gorm` + `MySQL`，去看各自的官方教程即可。

[Gin](https://gin-gonic.com/) 是一个用 Go 编写的 Web HTTP 框架，性能高且语法简洁，适合新手入门也适合大型项目的开发；Gorm 是
